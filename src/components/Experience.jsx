											...
											<div class="flip-card-inner">
												<div className="flip-card-front">
													...
													<Card.Body>
														...
														<Card.Text>
															<p align="center">
																Online Fashion Shopping App where user can order online.
															</p>
														</Card.Text>
													</Card.Body>
												</div>
												<div className="flip-card-back">
													<p>
														An Online Shopping Website where users
														can login to the site and add their 
														favorite Fashion items to cart and 
														User can also sort and filter his
														favorite Fashion item and pay the payment and
														the items get delivered to their
								...
								>
									...
									<center>
										<div class="flip-card">
											<div class="flip-card-inner">
												<div className="flip-card-front">
													<Card.Img variant="top" src={zoompic} />
													<Card.Body>
														<Card.Title align="center">
															ZoomCar.com(Clone)
														</Card.Title>
														<Card.Text>
															<p align="center">
																India's Largest Online car sharing and renting platform.
															</p>
														</Card.Text>
													</Card.Body>
												</div>
												<div className="flip-card-back">
													<p>
													India’s first personal mobility platform,
													with the introduction of car-sharing services in 2012.
													Zoomcar allows users to rent cars by the hour, day, week, or month.
													it is currently the market leader in the personal mobility space with over 10,000 cars in its fleet.
													</p>
													<Button
														variant={
															darkMode
